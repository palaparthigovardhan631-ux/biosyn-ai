...
const Header: React.FC<HeaderProps> = ({ language, onLanguageChange, isAuthenticated, user, onLogout, isOnline, onOpenInfo }) => {
      ...
      <div className="container mx-auto px-6 h-20 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-4">
          ...
          {isAuthenticated && user && (
            <div className="hidden md:flex items-center space-x-3 border-l border-slate-800 pl-4 animate-fadeIn">
